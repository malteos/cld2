...
SOURCES: dict[str, dict[str, Any]] = {
    ...
    "acf": {"wikipedia": None, "sources": [
        {"url": "https://stlucia.loopnews.com/", "type": "news", "description": "Loop News Saint Lucia (English + Kwéyòl items)"},
        {"url": "https://www.stlucianewsonline.com/", "type": "news", "description": "St. Lucia News Online"},
        {"url": "https://www.govt.lc/", "type": "gov", "description": "Government of Saint Lucia (Kwéyòl-language cultural items)"},
        {"url": "https://www.potomitan.info/", "type": "education", "description": "Potomitan — Caribbean-creole literature / education portal"},
        {"url": "https://www.jw.org/lcf/", "type": "religious", "description": "jw.org Saint Lucian Creole (as 'lcf')"},
    ]},
    "aeb": {"wikipedia": None, "sources": [
        {"url": "https://www.babnet.net/", "type": "news", "description": "BabNet — Tunisian news with frequent Tunisian-Arabic"},
        {"url": "https://www.tunisienumerique.com/", "type": "news", "description": "Tunisie Numérique"},
        {"url": "https://www.jamaity.org/", "type": "civil", "description": "Jamaity — Tunisian civil-society portal"},
    ...
    "apd": {"wikipedia": None, "sources": [
        {"url": "https://www.sudantribune.net/", "type": "news", "description": "Sudan Tribune — Sudanese news"},
        {"url": "https://www.alrakoba.net/", "type": "news", "description": "Al Rakoba — Sudanese news portal"},
        {"url": "https://sudanakhbar.com/", "type": "news", "description": "Sudan Akhbar"},
        {"url": "https://www.sudaress.com/", "type": "news", "description": "Sudaress — Sudanese press aggregator"},
    ]},
    ...
    "fro": {"wikipedia": "fro", "sources": [
        {"url": "https://fro.wikipedia.org/", "type": "cultural", "description": "Old French Wikipedia"},
    ...
    "fuv": {"wikipedia": None, "sources": [
        ...
        {"url": "https://www.rfi.fr/ha/", "type": "news", "description": "RFI Hausa (West-African lingua franca close to Fulfulde)"},
        {"url": "https://kaceendafr.info/", "type": "news", "description": "Kaceendafr — Senegalese Pulaar portal"},
        {"url": "https://www.bbc.com/fulah", "type": "news", "description": "BBC Fulah Mandingo services"},
    ]},
    ...
    "gcf": {"wikipedia": None, "sources": [
        {"url": "https://la1ere.francetvinfo.fr/guadeloupe/", "type": "news", "description": "Guadeloupe La 1ère (French + Kréol Gwadloupéyen)"},
        {"url": "https://www.potomitan.info/", "type": "education", "description": "Potomitan — Caribbean-creole literature / education portal"},
    ...
    "gcr": {"wikipedia": None, "sources": [
        {"url": "https://la1ere.francetvinfo.fr/guyane/", "type": "news", "description": "Guyane La 1ère (French + Guianese Creole)"},
        {"url": "https://www.potomitan.info/", "type": "education", "description": "Potomitan — Caribbean-creole literature / education portal"},
    ...
    "grc": {"wikipedia": "grc", "sources": [
        {"url": "https://grc.wikipedia.org/", "type": "cultural", "description": "Ancient Greek Wikipedia"},
    ...
    "guw": {"wikipedia": None, "sources": [
        {"url": "https://www.24haubenin.info/", "type": "news", "description": "24 Heures au Bénin (news from Benin; some Gungbe)"},
    ...
    "hbo": {"wikipedia": None, "sources": [
        ...
        {"url": "https://mechon-mamre.org/p/pt/pt0.htm", "type": "cultural", "description": "Mechon Mamre — Hebrew Bible"},
    ]},
    ...
    "nso": {"wikipedia": None, "sources": [
        {"url": "https://www.salanguages.com/sesotho/", "type": "education", "description": "SA Languages — Sesotho sa Leboa resources"},
        ...
        {"url": "https://www.dac.gov.za/", "type": "gov", "description": "SA Department of Arts and Culture"},
    ]},
    "nyn": {"wikipedia": None, "sources": [
        ...
        {"url": "https://www.radioperformanceug.com/", "type": "news", "description": "Radio Performance Uganda (Runyankore / English)"},
        {"url": "https://www.mak.ac.ug/", "type": "education", "description": "Makerere University — Runyankore-Rukiga department"},
    ]},
    ...
    "rcf": {"wikipedia": None, "sources": [
        {"url": "https://la1ere.francetvinfo.fr/reunion/", "type": "news", "description": "Réunion La 1ère (French + Kréol Rénioné)"},
        {"url": "https://www.zinfos974.com/", "type": "news", "description": "Zinfos 974 — Réunion news"},
        {"url": "https://www.clicanoo.re/", "type": "news", "description": "Clicanoo / Journal de l'Île de La Réunion"},
    ...
    "uzs": {"wikipedia": None, "sources": [
        {"url": "https://da.azadiradio.com/", "type": "news", "description": "Radio Azadi — RFE/RL Afghanistan (Dari + Southern Uzbek reports)"},
        {"url": "https://www.rta.org.af/", "type": "news", "description": "Radio Television Afghanistan"},
